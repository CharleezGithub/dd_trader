...
if len(sys.argv) > 1 and not len(sys.argv) > 2:
    ...
    image_name = "dd_bot/temp_images/info/image5.png"
...
if tries < max_tries:
    ...
    color_image = cv2.cvtColor(main_image, cv2.COLOR_GRAY2BGR)


    # Draw a rectangle around the matched object
    cv2.rectangle(color_image, top_left, bottom_right, (0, 255, 0), 1)
